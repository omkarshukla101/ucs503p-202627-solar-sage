      ...
      <main className="flex-1">
        ...
        {session === "missing" && (
          <div className="max-w-[900px] mx-auto px-6 md:px-10 py-32 text-center">
            ...
            <p className="body-md max-w-md mx-auto mb-8">
              The simulator runs against a saved inspection. The session it points at isn&apos;t in your
              local history.
            </p>
        ...
        {session && session !== "missing" && (
          <section className="relative">
            <div className="max-w-[1200px] mx-auto px-6 md:px-10 pt-12 md:pt-16 pb-16 md:pb-24 space-y-10">
              <motion.div
              ...
              >
                <div>
                  ...
                  <h1 className="h-display text-[44px] md:text-[72px] leading-[1.02] mt-2">
                    What if you <em className="italic text-[var(--accent-2)]">fixed it</em>?
                  </h1>
                  <p className="body-md mt-3 max-w-[60ch]">
                    Toggle defects you would address, scenario presets, or click into individual panels.
                    The fleet health score, efficiency loss, and annual energy ledger recompute live.
                  </p>
                </div>
                <Link
